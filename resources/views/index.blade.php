                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="truncated-text">
                            <p class="card-text text-flow truncate-text text-justify">
                                {{ $item->description }}
                            </p>
                        </div>
                        <div>
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                <a class="text-decoration-none blue" href="{{ route('Main.viewRecipe', $item['id']) }}">
                                    <h5 class="card-title text-wrap-balance">{{ $item['title'] }}</h5>
                                    <a class="custom-reply" href="{{ route('Main.profile', $item['id']) }}">
                                        By: {{ $item['user']['first_name'] }} {{ $item['user']['last_name'] }}
                                    </a>
                                </a>
                                <div class="truncated-text-50">
                                    <p class="card-text text-justify truncate-text"> 
                                        {{ $item['description'] }}
                                    </p>
                                </div>
                                <p class="card-text">
