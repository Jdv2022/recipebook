        ...
        <div class="modal-content">
            ...
            <form action="{{ route('Recipes.edit', $data['id']) }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" name="title" class="form-control" aria-describedby="textHelp" value="{{ (old('title'))?old('title'):$data['title'] }}">
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('Recipes.edit', $data['id']) }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <textarea name="description" class="form-control" aria-describedby="textHelp">{{ (old('description'))?old('description'):$data['description'] }}</textarea>
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('Recipes.edit', $data['id']) }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <input name="duration" class="form-control" aria-describedby="textHelp" value="{{ (old('duration')) ? old('duration') : $recipe_add_info['duration'] }}"/>
                    ...
                    <input name="good_for" class="form-control" aria-describedby="textHelp" value="{{ (old('good_for'))?old('good_for'):$recipe_add_info['good_for'] }}"/>
                    <div id="textHelp" class="form-text">Good for must not be more than 20 letters.</div>
                    @error('good_for')
                        <span class="text-danger m-0 custom-small d-block">{{ $message }}</span>
                    @enderror
                    <label class="form-label">Difficulty</label>
                    <input name="difficulty" class="form-control" aria-describedby="textHelp" value="{{ (old('difficulty'))?old('difficulty'):$recipe_add_info['difficulty'] }}"/>
                    <div id="textHelp" class="form-text">Difficulty must not be more than 20 letters.</div>
                    @error('difficulty')
                        <span class="text-danger m-0 custom-small d-block">{{ $message }}</span>
                    @enderror
                    <label class="form-label">Budget</label>
                    <input name="budget" class="form-control" aria-describedby="textHelp" value="{{ (old('budget'))?old('budget'):$recipe_add_info['budget'] }}"/>
                    <div id="textHelp" class="form-text">Duration must not be more than 20 letters.</div>
                    @error('budget')
                        <span class="text-danger m-0 custom-small d-block">{{ $message }}</span>
                    @enderror
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('Recipes.edit', $data['id']) }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <textarea name="ingredients" class="form-control" aria-describedby="textHelp">{{ (old('ingredients'))?old('ingredients'):$original_ingredients }}</textarea>
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('Recipes.edit', $data['id']) }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <textarea name="method" class="form-control" aria-describedby="textHelp">{{ (old('method'))?old('method'):$original_instructions }}</textarea>
...
<div class="modal fade" id="edit-mainImg-recipe-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <form action="{{ route('Recipes.edit', $data['id']) }}" method="POST" enctype="multipart/form-data">
                @method('PATCH')
                @csrf
                <div class="modal-body">
                    <div>
                        <input type="hidden" name="hidden" value="main_recipeImg_modal" />
                        <input type="hidden" name="original_url" value="{{ $data['url'] }}" />
